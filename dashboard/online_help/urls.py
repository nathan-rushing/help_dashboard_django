...
urlpatterns = [
    ...
    path('home_test/per_user/<int:writer_pk>/', views.per_user_test, name='per_user_test'),
    ...
    path('home_test/per_user/<int:writer_pk>/per_subsection/<int:task_pk>/', views.per_subsection_test, name='per_subsection_test'),
    path('home_test/per_user/<int:writer_pk>/per_subsection/<int:task_pk>/per_user_edit_test/', views.per_user_edit_test, name='per_user_edit_test'),
